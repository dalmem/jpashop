...
public class OrderServiceTest {
    ...
    public void 재고수량초과주문() throws Exception{
        Member member = createMember();
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals("주문 취소시 상태는 CANCEL입니다.", OrderStatus.CANCEL, getOrder.getStatus());
        assertEquals("주문이 취소된 상품은 재고가 증가", 10, item.getStockQuantity());
    }
